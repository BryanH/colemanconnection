  ...
  return this.each(function () {
    ...
    */
    ...
    // 3. Insert the tabbed menu
      if (options.dynamicTabs) {
        $tabs = $('<div class="content-player-tabs-container clearfix"><div class="btn-group" /></div>');
        $slides.each(function (num) {
          ...
          $tabs.find(":first").append('<a class="btn" href="#' + num + '">' + label + '</a>');
        });
    ...
    */
    function next (currentSlideIndex) {
      ...
      $('.active', $slidesWrapperOverflowDiv).removeClass('active');
      $slidesWrapperOverflowDiv.animate({ marginLeft : offset, height : $nextSlide.height() }, options.slideEaseDuration, options.slideEaseFunction, function () {
    ...
    function prev (currentSlideIndex) {
      ...
      $('.active', $slidesWrapperOverflowDiv).removeClass('active');
      $slidesWrapperOverflowDiv.animate({ marginLeft : offset, height : $prevSlide.height() }, options.slideEaseDuration, options.slideEaseFunction, function () {
    ...
    function setCurrentTab (position) {
      if (options.dynamicTabs) {
        $tabs
          ...
          .end()
          .find('[href=#' + position + ']').addClass("btn-primary");
      }
    };
